...
namespace APITemplate.Migrations
{
    ...
    public partial class AddFullTextSearchIndexes : Migration
    {
        ...
        {
            migrationBuilder.DropIndex(name: "IX_Products_Name_Description", table: "Products");

            migrationBuilder.DropIndex(name: "IX_Categories_Name_Description", table: "Categories");
        }
    }
}
