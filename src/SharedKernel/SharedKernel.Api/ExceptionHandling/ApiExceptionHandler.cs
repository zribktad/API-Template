...
/// responses with stable status codes and error codes.
/// </remarks>
public sealed class ApiExceptionHandler : IExceptionHandler
{
    ...
    ) Resolve(Exception exception)
    {
        ...
        {
            (int statusCode, string title, string defaultErrorCode) = MapToHttp(appException);
            string errorCode = ResolveErrorCode(appException, defaultErrorCode);
    ...
    private static string ResolveErrorCode(AppException appException, string defaultErrorCode)
    {
        ...
        if (
            ...
            && appException.Metadata.TryGetValue("errorCode", out object? metadataErrorCode)
