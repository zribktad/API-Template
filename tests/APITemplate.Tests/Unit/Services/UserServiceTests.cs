...
public class UserServiceTests
{
    ...
    public async Task GetByIdAsync_WhenUserExists_ReturnsUserResponse()
    {
        ...
        var result = await _sut.GetByIdAsync(expected.Id, ct);
    ...
    public async Task UpdateAsync_WhenUserExists_UpdatesFields()
    {
        ...
        await _sut.UpdateAsync(user.Id, new UpdateUserRequest("updateduser", "updated@test.com"), ct);
    ...
    public async Task UpdateAsync_WhenSameEmailAndUsername_SkipsUniquenessCheck()
    {
        ...
        await _sut.UpdateAsync(user.Id, new UpdateUserRequest(user.Username, user.Email), TestContext.Current.CancellationToken);
    ...
    public async Task UpdateAsync_WhenUserNotFound_ThrowsNotFoundException()
    {
        ...
        var act = () => _sut.UpdateAsync(Guid.NewGuid(), new UpdateUserRequest("name", "e@e.com"), TestContext.Current.CancellationToken);
    ...
    public async Task UpdateAsync_WhenNewEmailExists_ThrowsConflictException()
    {
        ...
        var act = () => _sut.UpdateAsync(user.Id, new UpdateUserRequest(user.Username, "taken@test.com"), TestContext.Current.CancellationToken);
    ...
    public async Task ActivateAsync_SetsIsActiveToTrue()
    {
        ...
        await _sut.ActivateAsync(user.Id, TestContext.Current.CancellationToken);
    ...
    public async Task DeactivateAsync_SetsIsActiveToFalse()
    {
        ...
        await _sut.DeactivateAsync(user.Id, TestContext.Current.CancellationToken);
    ...
    public async Task ActivateAsync_WhenUserNotFound_ThrowsNotFoundException()
    {
        ...
        var act = () => _sut.ActivateAsync(Guid.NewGuid(), TestContext.Current.CancellationToken);
    ...
    public async Task ChangeRoleAsync_ChangesUserRole()
    {
        ...
        await _sut.ChangeRoleAsync(user.Id, new ChangeUserRoleRequest(UserRole.PlatformAdmin), TestContext.Current.CancellationToken);
    ...
    public async Task ChangeRoleAsync_WhenUserNotFound_ThrowsNotFoundException()
    {
        ...
        var act = () => _sut.ChangeRoleAsync(Guid.NewGuid(), new ChangeUserRoleRequest(UserRole.PlatformAdmin), TestContext.Current.CancellationToken);
    ...
    public async Task DeleteAsync_CallsRepositoryDeleteAndCommits()
    {
        ...
        await _sut.DeleteAsync(user.Id, TestContext.Current.CancellationToken);
