...
public class ProductDataControllerTests : IClassFixture<AlbaApiFixture>
{
    private readonly HttpClient _client;
    private readonly Mock<IProductDataRepository> _repositoryMock;

    public ProductDataControllerTests(AlbaApiFixture fixture)
    {
        _client = fixture.Host.Server.CreateClient();
        _repositoryMock = fixture.Host.Services.GetRequiredService<Mock<IProductDataRepository>>();
