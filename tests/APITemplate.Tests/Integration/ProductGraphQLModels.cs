...
public sealed record ProductPriceFacetBucketItem(string Label, decimal MinPrice, decimal? MaxPrice, int Count);

public sealed record ProductFacets(List<ProductCategoryFacetItem> Categories, List<ProductPriceFacetBucketItem> PriceBuckets);

public sealed record ProductResultsPage(List<ProductItem> Items, int TotalCount, int PageNumber, int PageSize);
...
public sealed record ProductWithReviewsResultsPage(List<ProductWithReviewsItem> Items, int TotalCount, int PageNumber, int PageSize);

public sealed record ProductWithReviewsPage(ProductWithReviewsResultsPage Page, ProductFacets? Facets = null);
...
public sealed record CategoryResultsPage(List<CategoryItem> Items, int TotalCount, int PageNumber, int PageSize);
